...
import { getAssetsInAccount, getMarkets, getMintedSeb, useGetNTokenBalancesAll } from 'clients/api';
...
const fakeUserSebMintedWei = new BigNumber('10000000000000000');
...
describe('api/queries/useGetUserMarketInfo', () => {
  beforeEach(() => {
    ...
    (useGetNTokenBalancesAll as jest.Mock).mockImplementation(({ account }) => {
