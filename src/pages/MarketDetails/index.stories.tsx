...
import { nTokenApySimulations } from '__mocks__/models/vTokenApySimulations';
...
export const Default = () => (
  <MarketDetailsUi
    ...
    exchangeRateNTokens={new BigNumber(1.345)}
    supplyChartData={fakeApyChartData}
    borrowChartData={fakeApyChartData}
    interestRateChartData={nTokenApySimulations}
  />
);
