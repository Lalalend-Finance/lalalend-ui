...
import { getMarketHistory, getMarkets, getNTokenApySimulations } from 'clients/api';
import renderComponent from 'testUtils/renderComponent';

import MarketDetails from '.';
import TEST_IDS from './testIds';

const fakeNTokenId = 'aave';
...
describe('pages/MarketDetails', () => {
  beforeEach(() => {
    ...
    (getNTokenApySimulations as jest.Mock).mockImplementation(() => ({
