...
export const markets: Market[] = [
  /*{
    ...
    miaSpeeds: '868055555555555',
    borrowerDailyMia: '24999999999999984000',
    supplierDailyMia: '24999999999999984000',
    miaBorrowIndex: '2210175643147128470480696395322361791',
    miaSupplyIndex: '91889813521211553152699093059779893207720871',
    ...
    borrowMiaApy: new BigNumber('1.351224864211795426'),
    supplyMiaApy: new BigNumber('0.34260730848036692'),
  ...
  },*/
  {
    ...
    miaBorrowIndex: '2513615400744254791588851837018529233837991530424',
    miaSupplyIndex: '18116117080571703193166360612967778319506081',
    ...
    borrowMiaApy: new BigNumber('0.000002125348834693'),
    supplyMiaApy: new BigNumber('0.000000000001824635'),
  ...
  },
  {
    ...
    borrowerDailyMia: '499999996800000000000',
    supplierDailyMia: '499999996800000000000',
    miaBorrowIndex: '3134638383583341728502713472105366955237351527849',
    miaSupplyIndex: '50767324415277671717713798578861089685734426',
    ...
    borrowMiaApy: new BigNumber('0.600882672824011072'),
    supplyMiaApy: new BigNumber('0'),
  ...
  /*{
    ...
    borrowerDailyMia: '499999996800000000000',
    supplierDailyMia: '499999996800000000000',
    miaBorrowIndex: '1977043831598670394311169809751839506',
    miaSupplyIndex: '38295016263474853127387198168137067434727103',
    ...
    borrowMiaApy: new BigNumber('0.021753286763848276'),
    supplyMiaApy: new BigNumber('0.001730355354365121'),
  ...
  },*/
  {
    ...
    underlyingDecimal: 18,
    miaSpeeds: '52083333000000000',
    borrowerDailyMia: '1499999990400000000000',
    supplierDailyMia: '1499999990400000000000',
    miaBorrowIndex: '92261298258604607734236764270543938131',
    miaSupplyIndex: '5555348755303865713384375826666176140873676775',
    ...
    borrowMiaApy: new BigNumber('1.141107132664179593'),
    supplyMiaApy: new BigNumber('1.185821799653397884'),
  ...
  {
    id: 'mia',
    address: '0xd9edE9aDe6090987fB3eBE4750877C66b32c002E',
    symbol: 'Venus MIA',
    name: 'nMIA',
    underlyingAddress: '0x8333AfA22De158606E74E9904f281D73e0023ED9',
    underlyingName: 'Venus',
    underlyingSymbol: 'MIA',
    underlyingDecimal: 18,
    miaSpeeds: '0',
    borrowerDailyMia: '0',
    supplierDailyMia: '0',
    miaBorrowIndex: '1306014178018669882667220692703167088',
    miaSupplyIndex: '12001246649616749573360284547054922972341230',
  ...
  /*{
    ...
    borrowerDailyMia: '1499999990400000000000',
    supplierDailyMia: '1499999990400000000000',
    miaBorrowIndex: '8237010669827405426237622982720904185744',
    miaSupplyIndex: '911988515347735640578828985342094388729427575950',
    ...
    borrowMiaApy: new BigNumber('4.543731091576054636'),
    supplyMiaApy: new BigNumber('1.606740170918635611'),
  ...
  },*/
  {
    ...
    underlyingDecimal: 18,
    miaSpeeds: '8680556000000000',
    borrowerDailyMia: '250000012800000000000',
    supplierDailyMia: '250000012800000000000',
    miaBorrowIndex: '250031321744071459446250818764213716945',
    miaSupplyIndex: '10408463243245581726461757424706480278275781678',
    ...
    borrowMiaApy: new BigNumber('0.594444965549789125'),
    supplyMiaApy: new BigNumber('0.363034531797658077'),
  ...
  /*{
    ...
    borrowerDailyMia: '250000012800000000000',
    supplierDailyMia: '250000012800000000000',
    miaBorrowIndex: '321358523398000000009439909426566439664968049259719783007',
    miaSupplyIndex: '295906201179204963066853606047186181856354518',
    ...
    borrowMiaApy: new BigNumber('7.470759902626424876'),
    supplyMiaApy: new BigNumber('0.811613513165150039'),
  ...
  },
  {
    ...
    borrowerDailyMia: '250000012800000000000',
    supplierDailyMia: '250000012800000000000',
    miaBorrowIndex: '622451095071161598652097266929531019308',
    miaSupplyIndex: '251271155543315652904648236787969071045489047',
    ...
    borrowMiaApy: new BigNumber('3.503840954113091774'),
    supplyMiaApy: new BigNumber('0.947264218064808693'),
  ...
  },
  {
    ...
    underlyingDecimal: 18,
    miaSpeeds: '3038194444444440',
    borrowerDailyMia: '87499999999999872000',
    supplierDailyMia: '87499999999999872000',
    miaBorrowIndex: '1008282137712710171867309314462820174',
    miaSupplyIndex: '445349220638603776370373170742792115390555',
    ...
    borrowMiaApy: new BigNumber('0.754335409204269745'),
    supplyMiaApy: new BigNumber('0.305120518892226646'),
  ...
  },
  {
    ...
    underlyingDecimal: 8,
    miaSpeeds: '1590451388888890',
    borrowerDailyMia: '45805000000000032000',
    supplierDailyMia: '45805000000000032000',
    miaBorrowIndex: '29477570851454787406649940643137103152567090469233157',
    miaSupplyIndex: '27877276110998742243410429219856328594550370',
    ...
    borrowMiaApy: new BigNumber('1.720862854912494938'),
    supplyMiaApy: new BigNumber('1.522555082433944633'),
  ...
  },
  {
    ...
    borrowerDailyMia: '87499999999999872000',
    supplierDailyMia: '87499999999999872000',
    miaBorrowIndex: '337022427603330627205286259129853279108',
    miaSupplyIndex: '16961889752853197148340604668736631001827316830',
    ...
    borrowMiaApy: new BigNumber('0.26982533135294494'),
    supplyMiaApy: new BigNumber('0.134967169585684514'),
  ...
  },
  {
    ...
    underlyingDecimal: 18,
    miaSpeeds: '434027777777778',
    borrowerDailyMia: '12500000000000006400',
    supplierDailyMia: '12500000000000006400',
    miaBorrowIndex: '39553441593665778531057823479294758655',
    miaSupplyIndex: '5261450495852361889187790090696845281',
    ...
    borrowMiaApy: new BigNumber('14.754861490074778241'),
    supplyMiaApy: new BigNumber('0.10787839946684478'),
  ...
  },
  {
    ...
    underlyingDecimal: 18,
    miaSpeeds: '868055555555556',
    borrowerDailyMia: '25000000000000012800',
    supplierDailyMia: '25000000000000012800',
    miaBorrowIndex: '12589249437558453888101548344939887411555371925',
    miaSupplyIndex: '2826595440882826063368695672513352662',
    ...
    borrowMiaApy: new BigNumber('200.564801757396621173'),
    supplyMiaApy: new BigNumber('0.009007365834885316'),
  ...
  },
  {
    ...
    borrowerDailyMia: '25000000000000012800',
    supplierDailyMia: '25000000000000012800',
    miaBorrowIndex: '1116319444444458592370842066276739685461583456998094593',
    miaSupplyIndex: '894429968864569340993764339122567201982791916',
    ...
    borrowMiaApy: new BigNumber('8102.522495213142034502'),
    supplyMiaApy: new BigNumber('0.334415260865180737'),
  ...
  },
  {
    ...
    borrowerDailyMia: '25000000000000012800',
    supplierDailyMia: '25000000000000012800',
    miaBorrowIndex: '77080111181810737992185003707845606313898',
    miaSupplyIndex: '105104177426619752874768721751867637569653744587',
    ...
    borrowMiaApy: new BigNumber('23422868925129157708929136429307036907.51510720619883895'),
    supplyMiaApy: new BigNumber('83.636157517717037851'),
  ...
  },
  {
    ...
    underlyingDecimal: 6,
    miaSpeeds: '1302083333333334',
    borrowerDailyMia: '37500000000000019200',
    supplierDailyMia: '37500000000000019200',
    miaBorrowIndex: '1000000000000000000000000000000000000',
    miaSupplyIndex: '43963519966277800287099999999999999999999999998',
    borrowRatePerBlock: '1902587519',
    supplyRatePerBlock: '0',
    ...
    borrowApy: new BigNumber(-2.014488268288307),
    supplyApy: new BigNumber('0'),
    borrowMiaApy: new BigNumber('Infinity'),
    supplyMiaApy: new BigNumber('1841951.587706392698558375'),
